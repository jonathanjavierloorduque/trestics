...
app = Flask(__name__)
limiter = Limiter(app=app, key_func=lambda: 'global')
...
if __name__ == '__main__':
    app.run(host="0.0.0.0",port=5000,debug=True, ssl_context=("/var/www/trestics/cert.pem","/var/www/trestics/key.pem"))
